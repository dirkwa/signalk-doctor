...
describe('resolveGuiUrl', () => {
  ...
  it('honors X-Forwarded-Proto for HTTPS-fronted reverse proxies', () => {
    ...
    expect(resolveGuiUrl(r)).toBe('https://public.example.com:3004');
  });
