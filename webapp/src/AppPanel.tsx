...
const CONSOLE_PATH = '/plugins/signalk-doctor/console/';
const INFO_PATH = '/plugins/signalk-doctor/api/info';
...
export default function AppPanel(_props: AppPanelProps) {
  ...
  if (state === 'probing') {
    return <div className="p-3 text-muted">Loading Doctor Console…</div>;
  }

  if (state === 'plugin-down') {
    return (
      <div className="alert alert-danger m-3" role="alert">
        <h5 className="alert-heading">signalk-doctor plugin is unreachable</h5>
        <p className="mb-1">
